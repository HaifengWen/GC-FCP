...
The mapping below is written from the perspective of a reader looking at the paper PDF. File names are included only as hints for where the scripts write their outputs.
...
Fig. 1 and Fig. 2 are schematic illustrations, not generated by the experiment scripts.
